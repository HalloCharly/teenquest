...
export function TeenTabNav() {
  const pathname = usePathname()

  const tabs = [
    { href: "/quests", icon: Home, label: "Home" },
    { href: "/teen-messages", icon: MessageSquare, label: "Messages" },
    { href: "/teen-dashboard", icon: BarChart3, label: "Dashboard" },
    { href: "/teen-profile", icon: User, label: "Profile" },
  ]
